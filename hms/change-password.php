...
$_SESSION['msg1']="Pass schimbat cu success !!";
}
else
{
$_SESSION['msg1']="parola veche nu coincide !!";
}
}
?>
<!DOCTYPE html>
...
{
alert("Parola curentă înregistrată este goală !!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("noua parola este goala !!");
