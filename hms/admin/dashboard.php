								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Rezervari</h2>
...
{
?>
											Total reservari :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
			...
			<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Interogări noi</h2>
...
?>
											Total Interogări noi :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
